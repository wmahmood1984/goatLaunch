        ...
        <div class="lg:pl-72">
          ...
          <main class="py-10 relative">
            <div class="px-4 sm:px-6 lg:px-8 mx-auto">
              ...
              <div class="flex items-center justify-center gap-20">
                <div>
                  ...
                  <div class="flex flex-col sm:flex-row flex-wrap justify-center gap-4 mb-6">
                    <div
                      class="block bg-neutral-600/25 rounded-3xl overflow-hidden shrink-0 flex-1 p-4 sm:min-w-[20rem] style-cGSC2"
                      id="style-cGSC2"
                    >
                ...
                <div>
                  ...
                  <div class="flex flex-col sm:flex-row flex-wrap justify-center gap-4 mb-6">
                    <div
                      class="block bg-neutral-600/25 rounded-3xl overflow-hidden shrink-0 flex-1 p-4 sm:min-w-[20rem] style-BIi8N"
                      id="style-BIi8N"
                    >
                      <div class="flex gap-x-4 mt-1 justify-center">
                        <a
                          class="  truncate text-3xl text-green-400  text-[#FFB921] hover:underline font-bold  "
                          href="viewpresale?tokenAddress=0x5EF159cfac8960c21B2219c789E5B810C6951B29"
                        >
                          BOOTY
                        </a>{" "}
                      </div>
                      <img
                        src="https://api.basejump.pro:4000/static/tkn_0x84a808eedd95473c024ee918344cd10aafb1c5837c7788a809b287e87ae3ee37.jpg"
                        class="rounded-full h-20 w-20 m-auto mt-4"
                        alt="Token Image"
                      />
                      <div class="flex justify-between mb-5">
                        ...
                        <div class="flex flex-col sm:items-end flex-shrink-0">
                          <div class="mt-1 flex justify-start space-x-2">
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              href="https://www.bootyonbase.com"
                            >
                              <svg
                                aria-hidden="true"
                                focusable="false"
                      ...
                      <div class="w-full bg-neutral-600/25 rounded-md overflow-hidden shrink-0 mb-4">
                        <div
                          class="bg-blue-700/50 p-1.5 text-center text-xs font-medium leading-none text-white style-QM7Fx"
                          id="style-QM7Fx"
                        >
                          100.00%
                        </div>
              ...
              className="relative z-10 flex flex-wrap justify-center gap-6 sm:flex-row sm:justify-between mobile"
              >
                {data &&
                  data.map((v, e) => (
